...
export function DataPanel({ stats, fountains }: DataPanelProps) {
  ...
  return (
    <Card className="w-[calc(100vw-72px)] sm:w-80 bg-white rounded-xl sm:rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.06)] border border-[#E1EDDA] ring-0 text-[#1A1A1A] max-h-[60vh] sm:max-h-none overflow-y-auto">
