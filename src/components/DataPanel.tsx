...
export function DataPanel({ stats, fountains }: DataPanelProps) {
  ...
  return (
    <Card className="w-80 bg-white rounded-2xl shadow-[0_4px_12px_rgba(0,0,0,0.05)] border-0 ring-0 text-[#1A1A1A]">
      <CardHeader className="pb-2">
        <CardTitle className="text-xl font-bold flex items-center justify-between">
          <span>Estadísticas</span>
          <Zap className="h-5 w-5 text-[#D96A27]" />
        </CardTitle>
        ...
        <div className="grid grid-cols-2 gap-4 mt-2">
          <div className="flex flex-col space-y-1">
            <span className="text-xs text-[#757575] flex items-center">
              <RouteIcon className="h-3 w-3 mr-1 text-[#4A7A30]" /> Distancia
            </span>
          ...
          <div className="flex flex-col space-y-1">
            <span className="text-xs text-[#757575] flex items-center">
              <Mountain className="h-3 w-3 mr-1 text-[#4A7A30]" /> Desnivel
            </span>
            <span className="text-2xl font-bold text-[#1A1A1A]">
          ...
          <div className="flex flex-col space-y-1 col-span-2 mt-2">
            <span className="text-xs text-[#757575] flex items-center">
              <Clock className="h-3 w-3 mr-1 text-[#D96A27]" /> Tiempo Estimado (Int.)
            </span>
